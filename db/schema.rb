...
ActiveRecord::Schema.define(version: 2022_04_28_051423) do
  ...
  create_table "addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["shipment_id"], name: "index_addresses_on_shipment_id"
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "family_name_c", null: false
    t.string "first_name_c", null: false
  ...
  add_foreign_key "addresses", "shipments"
